...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/WorldChattinggrouoforall'),
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 support', url='https://t.me/English_chatting_speaking'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/worldchattinghgroupforall'),     
        ],
        [
