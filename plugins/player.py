...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️Support', url='https://t.me/English_chatting_speaking'),
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/worldchattinggroupforall'),
            ]
            ]
        await m.reply("<b>You can't use this bot in this group, for that ask @Rishu_05 [Support](https://t.me/worldchattinggroupforall) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
